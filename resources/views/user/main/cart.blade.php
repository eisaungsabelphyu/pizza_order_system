            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0" id="dataTable">
                    ...
                    <tbody class="align-middle">
                        @foreach ($cart as $c)
                            <tr>
                                <td><img src="{{asset('storage/'.$c->pizza_image)}}" class="img-thumbnail shadow-sm" style="width: 50px;"></td>
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button class="btn btn-block btn-warning font-weight-bold my-3 py-3" id="orderBtn">
                            Proceed To Checkout
                        </button>
...
@section('scriptContent')
    ...
    <script>
        ...
        $('#clearBtn').click(function(){
            ...
            $('#finalTotalPrice').html("3000 kyats");
